<template>
  <div class="page">
    <div class="page__body">
      ...
      <div class="page__text" v-if="this.$store.getters.isAuth === false">
        ...
        <div>
          <ul class="page__list">
            ...
            <li class="page__list-item">
              VUEX - для реализации глобального хранилища, обеспечивающего
              рективное отображение данных, получаемых из Session Storage и
              IndexedDB
            </li>
            <li class="page__list-item">
              Библиотека VUElidate - для реактивной валидации полей различных
              форм
            </li>
            ...
            <li class="page__list-item">
              Session Storage - для хранения данных об аутентифицированном
              пользователе
            </li>
            <li class="page__list-item">
              Indexed DataBase - для хранения данных о пользователях и задачах,
              получаемых асинхронно при инициализации приложения и обновлямых
              при действиях над пользователями и задачами путем ответов на
              мутации глобального состояния
            </li>
          </ul>
        </div>
